...
import autoAwesomeIcon from '@iconify/icons-mdi/auto-awesome';
...
export default function Pricing() {
  return (
    ...
    >
      ...
      >
        {tiers.map((tier) => (
          <Grid xs={12} sm={6} md={4} key={tier.title}>
            {' '}
            {/* Keeping structure similar */}
            <Card
              sx={[
                {
                  p: 2,
            ...
            >
              <CardContent>
                ...
                >
                  ...
                  {tier.title === 'Professional' && (
                    <Chip icon={<Icon icon={autoAwesomeIcon} />} label={tier.subheader} />
                  )}
                </Box>
                <Box
                  sx={[
